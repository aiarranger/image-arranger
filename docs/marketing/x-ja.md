...
Media slot: attach the Aichan base references from `docs/assets/base/aichan_design.png` to post 1.
...
5. アプリ本体は依存ゼロ、Node.js 20+ だけ。サンプルデッキのキューは空で始まります。  
   依頼は明示的にキュー投入したときだけ作られ、完了には実際の生成結果が必要です。
