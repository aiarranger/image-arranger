...
- [ ] Post thread.
- [ ] Record URL:
- [ ] 24h metrics: impressions / engagements / profile clicks / GitHub stars:
...
Draft: `docs/marketing/note-ja.md`
...
- [ ] Publish.
- [ ] Record URL:
- [ ] 24h metrics: views / reactions / comments / GitHub referrals:

## Reddit

Draft: `docs/marketing/reddit-stablediffusion-en.md`

- [ ] Re-read current subreddit rules before posting.
- [ ] Choose a non-promotional flair if required.
- [ ] Attach media only if allowed.
- [ ] Avoid cross-posting immediately after dev.to/HN if it would look spammy.
- [ ] Post.
- [ ] Record URL:
- [ ] 24h metrics: upvotes / comments / GitHub referrals:
