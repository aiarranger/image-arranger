...
(() => {
  ...
  const I18N = {
    en: {
      ...
      screens_title: "One reference pack, several working views",
      screens_sub: "The page now shows the different states image-arranger manages: a source sheet, adopted images, request files, and gallery output.",
      screens_base_bar: "Reference pack — Aichan source of truth",
      screens_base_caption: "The design sheet is the source material, not the same screenshot repeated through the page.",
      screens_kit_card_title: "Request file",
      screens_kit_caption: "Queue work is plain JSON you can inspect before anything runs.",
      screens_gallery_caption: "Gallery uses adopted images, so the approved visual stays easy to find.",
      ...
      wf_video_caption: "Video view: start and end frames are explicit inputs for Vidu-style workflows.",
    ...
    ja: {
      ...
      screens_title: "1つの参照パックを、複数の作業状態で見せる",
      screens_sub: "source sheet、採用済み画像、依頼ファイル、ギャラリー出力という、image-arranger が管理する状態を分けて見せます。",
      screens_base_bar: "Reference pack — AIちゃんの正資料",
      screens_base_caption: "設定資料は元になる参照資料です。同じスクリーンショットをページ全体で繰り返す構成ではありません。",
      screens_kit_card_title: "依頼ファイル",
      screens_kit_caption: "キューの作業は、実行前に読めるプレーンなJSONです。",
      screens_gallery_caption: "Gallery では採用済み画像を表示し、承認した見た目をすぐ確認できます。",
      ...
      wf_video_caption: "Video 画面：Vidu などに渡す start/end フレームを明確な入力として管理します。",
      wf_queue_label: "05 · QUEUE",
