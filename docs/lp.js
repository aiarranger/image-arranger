...
(() => {
  ...
  const I18N = {
    en: {
      ...
      overview_card_aria: "Image-Arrangrer Aichan overview GIF",
      overview_primary_aria: "Open the English Aichan overview GIF",
      overview_links_aria: "Overview GIF language links",
      overview_poster_alt: "Poster for an English Aichan overview showing Image-Arrangrer organizing image, prompt, source, and video generation assets",
      overview_eyebrow: "Aichan overview",
    ...
    ja: {
      ...
      overview_card_aria: "Image-Arrangrer AIちゃん概要GIF",
      overview_primary_aria: "日本語のAIちゃん概要GIFを開く",
      overview_links_aria: "概要GIFの言語リンク",
      overview_poster_alt: "Image-Arrangrer がAIちゃんの画像、プロンプト、参照元、動画生成素材を整理する日本語概要GIFのポスター",
      overview_eyebrow: "AIちゃん概要",
